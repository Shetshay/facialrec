        ...
        <HomeLayout>
            ...
            <div className="flex flex-col items-center p-6 text-center">
                ...
                <div className="flex gap-4">
                    <Link href="/HomePage/about" className="px-4 py-2 bg-blue-500 rounded-lg text-white hover:bg-blue-600">
                        About Us
                    </Link>
                    <Link href="/HomePage/services" className="px-4 py-2 bg-blue-500 rounded-lg text-white hover:bg-blue-600">
                        Our Services
                    </Link>
                </div>
            </div>
