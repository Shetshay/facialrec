...
def get_face_comparison_result(original_face_data, new_face_data):
    # Compare the faces using multiple methods

    distance, pcc, cosine_sim = compare_faces(np.array(original_face_data), np.array(new_face_data))
